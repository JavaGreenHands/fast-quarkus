...
public class SysMenuResource {
    ...
    public List<SysMenu> getMenuList(
        ...
        return sysMenuService.getMenuList(new MenuQueryVo(pageNum, pageSize, menuName, parentId,dateType, DateUtils.parseDateTime(startTime),DateUtils.parseDateTime(endTime)));
